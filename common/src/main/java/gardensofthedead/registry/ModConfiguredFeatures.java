...
public class ModConfiguredFeatures {
    ...
    public static final DeferredRegister<ConfiguredFeature<?, ?>> CONFIGURED_FEATURES = DeferredRegister.create(GardensOfTheDead.MOD_ID, Registry.CONFIGURED_FEATURE_REGISTRY);

    public static final RegistrySupplier<ConfiguredFeature<HugeFlatFungusConfiguration, ?>> SOULBLIGHT_FUNGUS_PLANTED = CONFIGURED_FEATURES.register("soulblight_fungus_planted", () -> new ConfiguredFeature<>(ModFeatures.HUGE_SOULBLIGHT_FUNGUS.get(), new HugeFlatFungusConfiguration(
    ...
    public static final RegistrySupplier<ConfiguredFeature<HugeFlatFungusConfiguration, ?>> SOULBLIGHT_FUNGUS = CONFIGURED_FEATURES.register("soulblight_fungus", () -> new ConfiguredFeature<>(ModFeatures.HUGE_SOULBLIGHT_FUNGUS.get(), new HugeFlatFungusConfiguration(
            Blocks.SOUL_SOIL.defaultBlockState(),
            ModBlocks.SOULBLIGHT_STEM.get().defaultBlockState(),
            ModBlocks.BLIGHTWART_BLOCK.get().defaultBlockState(),
            false
    ...
    public static final RegistrySupplier<ConfiguredFeature<RandomPatchConfiguration, ?>> SHORT_STANDING_SOUL_SPORE_PATCH = soulSporePatch(
    ...
    public static final RegistrySupplier<ConfiguredFeature<RandomPatchConfiguration, ?>> LONG_STANDING_SOUL_SPORE_PATCH = soulSporePatch(
    ...
    public static final RegistrySupplier<ConfiguredFeature<RandomPatchConfiguration, ?>> SHORT_HANGING_SOUL_SPORE_PATCH = soulSporePatch(
    ...
    public static final RegistrySupplier<ConfiguredFeature<RandomPatchConfiguration, ?>> LONG_HANGING_SOUL_SPORE_PATCH = soulSporePatch(
    ...
    public static final RegistrySupplier<ConfiguredFeature<NetherForestVegetationConfig, ?>> SOULBLIGHT_FOREST_VEGETATION = register(
    ...
    public static final RegistrySupplier<ConfiguredFeature<BlockColumnConfiguration, ?>> WHISTLECANE_COLUMN = ModConfiguredFeatures.register(
            "whistlecane_column",
    ...
    public static final RegistrySupplier<ConfiguredFeature<NetherForestVegetationConfig, ?>> WHISTLING_WOODS_VEGETATION = register(
    ...
    public static final RegistrySupplier<ConfiguredFeature<RandomPatchConfiguration, ?>> TALL_BLISTERCROWN_PATCH = register(
    ...
    public static final RegistrySupplier<ConfiguredFeature<BlockPileConfiguration, ?>> NETHER_WART_BLOCK_PILE = register(
    ...
    private static RegistrySupplier<ConfiguredFeature<RandomPatchConfiguration, ?>> soulSporePatch(String name, int length, Direction direction, float glowingChance, Block... matchingBlocks) {
        return register(
                name,
                () -> Feature.RANDOM_PATCH,
    ...
    private static <T extends FeatureConfiguration> RegistrySupplier<ConfiguredFeature<T, ?>> register(String name, Supplier<? extends Feature<T>> feature, Supplier<T> config) {
