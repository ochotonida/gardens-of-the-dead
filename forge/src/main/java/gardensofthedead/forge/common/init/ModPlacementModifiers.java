...
import gardensofthedead.forge.common.placementmodifier.CountOnEveryCeilingPlacement;
...
public class ModPlacementModifiers {
    ...
    public static final DeferredRegister<PlacementModifierType<?>> PLACEMENT_MODIFIER_TYPES = DeferredRegister.create(Registry.PLACEMENT_MODIFIER_REGISTRY, GardensOfTheDead.MOD_ID);
