...
public class ModItems {
    ...
    public static final DeferredRegister<Item> ITEMS = DeferredRegister.create(Registry.ITEM_REGISTRY, GardensOfTheDead.MOD_ID);

    public static final CreativeModeTab CREATIVE_TAB = new CreativeModeTab(GardensOfTheDead.MOD_ID) {
        @Override
