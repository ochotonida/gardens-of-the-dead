...
import gardensofthedead.forge.common.block.entity.SignBlockEntity;
...
public class ModBlockEntityTypes {
    ...
    public static final DeferredRegister<BlockEntityType<?>> BLOCK_ENTITY_TYPES = DeferredRegister.create(Registry.BLOCK_ENTITY_TYPE_REGISTRY, GardensOfTheDead.MOD_ID);
